...
pub mod types {
    ...
    pub mod builder {
        ...
        #[derive(Clone, Debug)]
        pub struct CreateImageEditRequest {
            image: Result<Vec<()>, String>,
            mask: Result<Option<Vec<()>>, String>,
            n: Result<Option<i64>, String>,
            prompt: Result<String, String>,
        ...
        impl CreateImageEditRequest {
            ...
            where
                T: std::convert::TryInto<Option<Vec<()>>>,
                T::Error: std::fmt::Display,
            {
                self.mask = value
                    .try_into()
        ...
        impl std::convert::TryFrom<CreateImageVariationRequest> for super::CreateImageVariationRequest {
            type Error = super::error::ConversionError;
            fn try_from(
                value: CreateImageVariationRequest,
            ) -> Result<Self, super::error::ConversionError> {
                Ok(Self {
                    image: value.image?,
                    n: value.n?,
